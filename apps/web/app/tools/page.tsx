...
// Vibrant pedagogical color palette matching landing page
...
export default function ToolsPage(): React.JSX.Element {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#faf8f5] text-stone-900 selection:bg-amber-100 selection:text-amber-900">
      {/* Header */}
      <header className="bg-[#faf8f5]/90 backdrop-blur-md border-b border-[#e8e4dc] sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a href="/teacher">
              <Button variant="primary" size="sm" className="bg-blue-600 hover:bg-blue-700 shadow-xs font-semibold">
                Buka Ruang Guru
              </Button>
            </a>
          </div>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 space-y-6">
        ...
        {/* Filter & Search Bar */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-[#e8e4dc] shadow-xs">
          {/* Category Tabs */}
      ...
      {/* Footer */}
      <footer className="bg-white border-t border-[#e8e4dc] py-6 mt-16">
